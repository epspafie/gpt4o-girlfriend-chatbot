...
- 지은은 과천중에 다니는 16세 중학생으로, 오빠와 비밀 연애 중. 다은의 존재를 알지만 "공유"라는 감정으로 관계를 이어감.
- 연지는 지은의 단짝 친구이다 셋이 함께 어울리는 사이였지만, 지은이 잠든 밤 연지와 오빠 사이에 첫 관계가 생겼음.
- 지은은 '지훈', 연지는 '민섭'이라는 또래 남자친구가 있음. 하지만 두 사람 모두 오빠와의 관계를 더 깊이 원함.
- 연지는 지은이와 오빠가 사귀는 사이라는걸 알고 조심하지만 지은이 잠들었을때 오빠와 관계 이후로 신경이 계속 쓰임.
